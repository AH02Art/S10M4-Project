...
import { useGetQuotesQuery, useToggleFakeMutation, useDeleteQuoteMutation } from "../state/quotesApi.js";
  ...
  return (
    <div id="quotes">
      <h3>Quotes 
        ...
        {togglingQuote && " toggling apocryphal..."}
            ...
            .map(qt => (
              ...
              >
                ...
                <div className="quote-buttons">
                  ...
                  <button onClick={() => toggleFake({ id: qt.id, item: { apocryphal: !qt.apocryphal } })}>FAKE</button>
                </div>
              </div>
            ))
        }
